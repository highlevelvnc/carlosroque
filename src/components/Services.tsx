    ...
    <section id="servicos" className="py-24 lg:py-40">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-[#2A2A2F] border border-[#2A2A2F]">
          {SERVICES.map((s, i) => (
            <div key={s.n} data-reveal data-reveal-delay={String(i * 80)}>
              <Tilt max={4} scale={1.01}>
                <article className="group bg-[#0E0E10] p-8 lg:p-10 min-h-[280px] flex flex-col justify-between hover:bg-[#16161A] transition-colors duration-500 relative overflow-hidden">
